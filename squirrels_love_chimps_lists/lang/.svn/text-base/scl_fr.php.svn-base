...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	//A
	'abonnement_mailinglists' => 'Abonnement aux mailinglists',
	'actualiser_mailinglists_ajout' => 'Quand un auteur est ajouté ?',
	'actualiser_mailinglists_actualise' => 'Quand un le profil d\'un auteur est actualisé (synchroniser la mailing list) ?',
	'actualiser_mailinglists_enlever' => 'Quand un auteur est enlevé - mis en poubelle (enlever de la mailing list) ?',
	...
	'champs_supp' => 'Quels informtions additionnel de SPIP vouliez vous utiliser pour la synchronisation avec MailChimp (Email est toujours synchronisé)',
	'champs_supp_mapping' => 'Utilisez le tableau suivant pour accorder les champs spip, aux champs MailChimp',
	'choix_mailinglists_abonnement' => 'Choissisez la/les listes',
	'choix_mailinglists' => 'Quelle mailinglists vouliez vous actualiser automatiquement ',
	...
	//M
	'mailinglists' => 'Les mailinglistes',
	'mailinglists_dispos' => 'Les mailinglistes diponibles :',
	'modele' => 'Le modèle :',
	'modeles' => 'Les modèles :',
